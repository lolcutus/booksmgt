...
public class Author extends TableRow {
    ...
    public Author(int authorID, String firstName, String middleName, String name)
            throws DBException {
        super("author");
        this.rowID = authorID;
    ...
    private void setAll(String text, String separator) throws DBException {
        ...
        if (ms.hasMoreTokens()) {
            this.middleName.setValue(this.middleName.getStringValue() + " "
        ...
        if (this.name.getStringValue() == null || this.name.getStringValue().equals("")) {
            if (this.middleName.getStringValue() == null
                    || this.middleName.getStringValue().equals("")) {
                if (this.firstName.getStringValue() != null
                        || this.firstName.getStringValue().equals("")) {
    ...
    /*
     * public void show() { System.out.println("First Name: -" + getFirstName() + "-");
     * System.out.println("Middle Name: -" + getMiddleName() + "-"); System.out.println("Name: -" +
     * getName() + "-"); }
     */
    ...
    /*
     * public String getConcatenateName() { String rez = ""; if (this.firstName.getStringValue() !=
     * null) { rez = rez + firstName.getStringValue(); } if (this.middleName.getStringValue() !=
     * null) { rez = rez + this.middleName.getStringValue(); } if (this.name.getStringValue() !=
     * null) { rez = rez + this.name.getStringValue(); } return rez; }
     */
                ...
                if (tmp.getNodeType() == Node.ELEMENT_NODE) {
                    if (tmp.getLocalName().equalsIgnoreCase("name")) {
                        ...
                        if (tmp.getChildNodes().item(0) != null
                                && !tmp.getChildNodes().item(0).equals("")) {
    ...
    protected void init() throws DBException {
        // firstName
        this.firstName = new TableCellString(new TableColumn(Author.COLUMN_FIRST_NAME,
                String.class, false, "firstName"));
        this.cells.put(Author.COLUMN_FIRST_NAME, this.firstName);
        // middleName
        this.middleName = new TableCellString(new TableColumn(Author.COLUMN_MIDDLE_NAME,
                String.class, true, "middleName"));
        this.cells.put(Author.COLUMN_MIDDLE_NAME, this.middleName);
        // Name
        this.name = new TableCellString(new TableColumn(Author.COLUMN_NAME, String.class, false,
                "name"));
